...
dependencies {
    ...
    // from CodeRelayAndroid's own sources. :shared-session api-exposes
...
val generateBuildInfo by tasks.registering {
    ...
    outputs.dir(outDir)
    doLast {
        val file = outDir.get().asFile.resolve("relay/app/BuildInfo.kt")
        file.parentFile.mkdirs()
        file.writeText(
            """
            |package relay.app
            |
            |/** Generated by app/build.gradle.kts — do not edit. */
            |object BuildInfo {
...
sourceSets["main"].kotlin.srcDir(generateBuildInfo.map { generatedBuildInfoDir })
    ...
    application {
        ...
        nativeDistributions {
            ...
            linux {
                ...
                // Rendered from packaging/coderelay.svg (rsvg-convert, 512 px);
                // jpackage copies it into the image as lib/coderelay.png, which
                // is the path the PKGBUILD installs into hicolor.
                iconFile.set(rootProject.file("packaging/coderelay.png"))
            }
