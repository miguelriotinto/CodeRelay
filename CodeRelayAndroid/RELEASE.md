# Releasing the CodeRelay Android client
...
Create `CodeRelayAndroid/keystore.properties` (the Android project root, next
...
1. **Create the app**: Play Console → Create app → name "CodeRelay", default
