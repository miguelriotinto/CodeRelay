...
private let logger = Logger(subsystem: "com.coderelay.client", category: "RelayConnection")

/// Manages a WebSocket connection to a CodeRelay server with connection quality monitoring.
///
